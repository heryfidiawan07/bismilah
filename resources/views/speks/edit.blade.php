...
<div class="row">
	<div class="col-md-10">
		<h4 class="text-center">Edit spesifikasi</h4>
      ...
      <div class="form-group {{ $errors->has('mobil_id') ? ' has-error' : '' }} ">
          ...
          <select name="mobil_id" class="form-control">
            <option value="{{$speks->mobil->id}}">{{$speks->mobil->model}}</option>
      ...
      <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }} ">
          ...
          <input type="text" name="title" class="form-control" value="{{$speks->title}}">
          @if($errors->has('title'))
      ...
      <div class="form-group {{ $errors->has('speks') ? ' has-error' : '' }} ">
          ...
          <textarea name="speks" rows="20" class="form-control">{{$speks->speks}}</textarea>
          @if($errors->has('speks'))
