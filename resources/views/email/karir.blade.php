          ...
          <tr>
            <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
              ...
              <p style="{{ $style['paragraph'] }}">
                Ada yang pengen jadi marketing nih BOSS, tungggu dia bayar dulu BOSS baru di aktifkan tunggu email kalo dia udah bayar.
              </p>
          <!-- Action Button -->
                ...
                <tr>
                  <td align="center">
                    ...
                    <a href="http://kampusmobil.com//admin/marketings"
                      ...
                      class="button"
                      target="_blank">
                      Klik disini BOSS untuk lihat siapa yang daftar iklan marketing
                    </a>
                  </td>
                </tr>
              </table>
