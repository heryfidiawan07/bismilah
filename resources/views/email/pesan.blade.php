          ...
          <tr>
            <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
              ...
              <p style="{{ $style['paragraph'] }}">
                Anda mendapat pesan baru dari {{$pesan->email}}
              </p>
          <!-- Action Button -->
              <table style="{{ $style['body_action'] }}" align="center" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center">
                    ...
                    ?>
                    <a href="http://kampusmobil.com/admin/pesan"
                      style="{{ $fontFamily }} {{ $style['button'] }} {{ $style[$actionColor] }}"
                      class="button"
                      target="_blank">
                      Klik disini BOSS untuk lihat pesannya.
                    </a>
                  </td>
                </tr>
              </table>
              ...
              <table style="{{ $style['body_sub'] }}">
                <tr>
                  <td style="{{ $fontFamily }}">
                    ...
                    <p style="{{ $style['paragraph-sub'] }}">
                      <a style="{{ $style['anchor'] }}" href="http://kampusmobil.com/admin/pesan" target="_blank">
                        http://kampusmobil.com/admin/pesan
                      </a>
                    </p>
                  </td>
                </tr>
