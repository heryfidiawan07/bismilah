          ...
          <tr>
            <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
              ...
              <h1 style="{{ $style['header-1'] }}">
                Hallo BOSS Hery Fidiawan @FounderKampusMobil
              </h1>
              <!-- Intro -->
              <p style="{{ $style['paragraph'] }}">
                Anda dapat masukan nih, semoga jadi tambah semangat yah,,,,AMIN
              </p>
          <!-- Action Button -->
                ...
                <tr>
                  <td align="center">
                    ...
                    <a href="http://kampusmobil.com/admin/kritik-dan-saran/{{$kritik->title}}/{{$kritik->id}}"
                      ...
                      class="button"
                      target="_blank">
                      Klik disini BOSS untuk melihat kritik nya
                    </a>
                  </td>
                </tr>
              </table>
              ...
              <table style="{{ $style['body_sub'] }}">
                <tr>
                  <td style="{{ $fontFamily }}">
	                  ...
	                  <p style="{{ $style['paragraph-sub'] }}">
                      <a style="{{ $style['anchor'] }}" href="http://kampusmobil.com/admin/kritik-dan-saran/{{$kritik->title}}/{{$kritik->id}}" target="_blank">
                        http://kampusmobil.com/admin/kritik-dan-saran/{{$kritik->title}}/{{$kritik->id}}
                      </a>
	                  </p>
                  </td>
                </tr>
