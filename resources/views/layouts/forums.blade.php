@if($threads->count())
	...
	<div class="col-md-4">
		<div class="panel panel-default frm">
			<div class="panel-body">
				...
				<img src="<?php if (file_exists(public_path("member/".$thread->user->img))) echo '/member/' ?>{{$thread->user->avatar()}}" class="img-circle pull-left" style="margin-left: 3px; margin-right: 3px;">
